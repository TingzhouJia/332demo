			...
			<div class="footer__container">
				<div class="footer__row">
					<div class="footer__column">
						...
						<div class="footer__email"><a class="footer__email-link" href="mailto:info@ospca.on.ca">info@ospca.on.ca</a></div>

						<div class="footer__charity-number">Charitable Business # 88969-1044-RR0002</div>
					</div>
					<div class="footer__column">
						<h3 class="footer__heading">Links</h3>
						<ul class="footer-menu footer-menu--arrow footer-menu--depth-1 footer-menu--length-8" data-template="menu.twig">

							<li class="footer-menu__item footer-menu__item--type-post_type footer-menu__item--object-page footer-menu__item--20218">
								<a class="footer-menu__link" target="" href="https://ontariospca.ca/contact-us/">Contact Us</a>
							</li>

							<li class="footer-menu__item footer-menu__item--type-post_type footer-menu__item--object-page footer-menu__item--21089">
								<a class="footer-menu__link" target="" href="https://ontariospca.ca/contact-us/ontario-spca-animal-centre-locations/">Animal
									Centre Locations</a>
							</li>

							<li class="footer-menu__item footer-menu__item--type-post_type footer-menu__item--object-page footer-menu__item--28322">
								<a class="footer-menu__link" target="" href="https://ontariospca.ca/adopt/">Adopt</a>
							</li>

							<li class="footer-menu__item footer-menu__item--type-post_type footer-menu__item--object-page footer-menu__item--20221">
								<a class="footer-menu__link" target="" href="https://ontariospca.ca/volunteer/">Volunteer</a>
							</li>

							<li class="footer-menu__item footer-menu__item--type-post_type footer-menu__item--object-page footer-menu__item--20219">
								<a class="footer-menu__link" target="" href="https://ontariospca.ca/blog/">Blog</a>
							</li>

							<li class="footer-menu__item footer-menu__item--type-post_type footer-menu__item--object-page footer-menu__item--20694">
								<a class="footer-menu__link" target="" href="https://ontariospca.ca/media-releases/">Media Releases</a>
							</li>

							<li class="footer-menu__item footer-menu__item--type-post_type footer-menu__item--object-page footer-menu__item--20220">
								<a class="footer-menu__link" target="" href="https://ontariospca.ca/who-we-are/employment/">Employment</a>
							</li>

							<li class="footer-menu__item footer-menu__item--type-post_type footer-menu__item--object-page footer-menu__item--20210">
								<a class="footer-menu__link" target="" href="https://ontariospca.ca/spca-professional/">SPCA Professional</a>
							</li>
						</ul>
					</div>
					<div class="footer__social footer__column">
						<h3 class="footer__heading">Follow Us</h3>
						<ul class="social-menu social-menu--footer social-menu--depth-1 social-menu--length-7" data-template="menu.twig">
							...
							<li class="social-menu__item--rss social-menu__item social-menu__item--custom social-menu__item--object-custom social-menu__item--199">
								<a class="social-menu__link" target="" href="http://ontariospca.ca/blog/">Blog</a>
							</li>

							<li class="social-menu__item--podcast social-menu__item social-menu__item--custom social-menu__item--object-custom social-menu__item--200">
								<a class="social-menu__link" target="_blank" href="https://ontariospca.ca/blog/category/podcast/">Pawdcast</a>
							</li>
						</ul>
					</div>
					<div class="footer__column">
						...
						<a href="https://ontariospca.ca/contact-us/" class="footer__map-link">
							<img src="https://ontariospca.ca/wp-content/uploads/2019/03/OntarioSPCA_BranchMap_ALL.png" alt="" class="footer__map">
						</a>
					</div>
				</div>
			</div>
