        ...
        <div class="page page--page" id="page--863" itemscope="" itemtype="http://schema.org/WebPage" data-template="web-page-right-sidebar.twig">
            <div class="page__content">
                    ...
                    <div class="animal-profile__photos">
                        <div class="animal-photo-slider">
                            <div class="animal-photo-slider__photos">
                                <img src="https://ospca-mym-prod.imgix.net/images/photos/animals/225371/151506.jpg?w=300&amp;h=330&amp;fit=crop&amp;crop=edge" class="photos__photo--active">
                            </div>
                        </div>
                    </div>
                    <div class="animal-profile__info">
                        <div class="animal-profile__info__top">
                            <div class="animal-profile__info__top__bio">
                                <div class="animal__name">
                                    <!----> <span class="animal__info__value">Hi! I'm Butch</span></div>
                                ...
                                <div class="animal__color"><span class="animal__info__label">Colour</span> <span class="animal__info__value">Black</span></div>
                                <div class="animal__weight"><span class="animal__info__label">Weight</span> <span class="animal__info__value"></span></div>
                                ...
                                <div class="animal-location"><span class="animal__info__label">Location</span> <span class="animal__info__value"><span class="animal-location__value__name">Ontario SPCA - Leeds &amp; Grenville Animal Centre</span> <span class="animal-location__value__address1">800 Centennial Road, R.R 4</span> <span class="animal-location__value__suburb">Brockville</span> <span class="animal-location__value__state">Ontario</span> <span class="animal-location__value__postcode">K6V 5T4</span>
                                ...
                                <div class="animal__contact"><span class="animal__info__label">Contact</span> <span class="animal__info__value"><a href="tel:+1 613-345-5520">613-345-5520</a></span></div>
                                <!---->
                            </div>
                        ...
                        <div class="animal-profile__info__bottom">
                            <div class="animal-profile__buttons">
                                <a href="https://ontariospca.ca/adopt/meet-your-match/feline-ality/mym-survey-cat/" class="button-link" target="_blank">Take Survey</a> 
                                <a href="javascript:void(0);" class="button-link" id="adopt_me">Adopt Me</a> 
                                <a href="javascript:void(0);" class="button-link" id="move_me" >Move to Another Location</a></div>
                        </div>
                    </div>
                </div>
                ...
                <section class="adopt_form" id="adopt_form">
                    <form class="adoptAnimal_form" name="AdoptForm">
                        <div class="form_item">
                        ...
                        <div class="form_item">
                        <label>Amount</label>
                        <input type="text" name="first_name" value="500" readonly/>
                        </div>
